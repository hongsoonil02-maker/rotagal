export const translations = {
  ko: {
    ...
    hero: {
      ...
      bannerDesc: "EU GMP 인증 · 보비젠(Bovigen Scour) 동일 제조 기반 백신",
      title1: "송아지 폐사율 감소의 핵심",
      title2: "설사예방 3종(로타·코로나·대장균) 혼합 백신 로타갈",
      subtitle: "송아지 설사병 위험을 낮추고 농가 운영 부담을 줄여주는 3종 혼합 예방 백신입니다.",
      mobileQuickLabel: "모바일 빠른 상담",
      mobileQuickTitle: "지금 바로 상담 신청하거나 대표 총판에 빠르게 연결하세요",
      mobileQuickPrimary: "상담 신청",
      mobileQuickSecondary: "대표 총판 전화",
    ...
    qualityShowcase: {
      ...
      subtitle: "로타갈은 보비젠(Bovigen Scour)과 동일 제조 기반으로 생산되며, EU GMP 인증과 국내 국가출하승인검정 면제 근거를 함께 갖춘 백신입니다.",
      quick1Label: "동일 제조 기반",
      quick1Value: "보비젠과 동일 제조소 공동 생산",
      quick2Label: "유통 안정성",
      quick2Value: "2~8℃ 콜드체인 직수입",
      quick3Label: "국내 신뢰 근거",
      quick3Value: "국가출하승인검정 면제 인정",
    ...
    infographic: {
      ...
      scheduleKrLabel1: "첫 접종(초임우):",
      scheduleKrLine1: "분만 6~5주전 1차 →",
      scheduleKrLine2: "분만 3~2주전 2차",
      scheduleKrLabel2: "재접종:",
      scheduleKrLine3: "분만 6~3주전 1회 접종",
      ...
      spec3Desc: "유럽 오리지널 백신 보비젠(Bovigen) 공동 생산",
    ...
    features: {
      ...
      subtitle: "현장에서 바로 체감할 수 있는 핵심 장점만 정리했습니다",
      item1Title: "EU GMP 프리미엄\u00A0품질",
      item1Desc: "엄격한 EU GMP 기준을 통과한 제조 시스템으로 안정적인 품질과 신뢰도를 제공합니다.",
    ...
    contact: {
      ...
      mobileCardLabel: "모바일 빠른 연결",
      mobileCallBtn: "전화 연결",
      mobileInquiryBtn: "상담 남기기",
    ...
    inquiry: {
      ...
      advTitle2: "고문수의사 젬스홍",
      advDesc: "학술 문의나 접종 상담이 필요하시면 바로 연결해드립니다",
      advTouch: "터치하시면 바로 전화 연결됩니다",
      formTitle: "빠른 제품 상담 문의",
      formSubtitle: "지역을 선택하시면 담당 총판 또는 상담 담당자가 순차적으로 연락드립니다.",
      point1Label: "응답 안내",
      point1Value: "접수 후 담당 총판이 순차 연락드립니다",
      point2Label: "연결 방식",
      point2Value: "선택 지역 기준으로 담당 총판에 연결됩니다",
      point3Label: "접수 정보",
      point3Value: "입력하신 정보는 상담 목적에만 사용됩니다",
      labelName: "농장주 성함",
      placeholderName: "홍길동",
      labelPhone: "연락처",
    ...
    footer: {
      ...
      mfg: "제조원: Pharmagal Bio, s.r.o. (슬로바키아, 유럽연합 제조소 승인번호 SK 82024 / 보비젠(Bovigen) 공동 생산 제조소)",
  ...
  en: {
    ...
    hero: {
      ...
      bannerTitle: "★ EUROPEAN UNION GMP CERTIFIED ★",
      bannerDesc: "EU GMP certified · vaccine produced on the same manufacturing basis as Bovigen Scour",
      title1: "The Core Solution for Calf Mortality Reduction",
      title2: "3-in-1 Diarrhea Prevention Vaccine: Rotagal",
      title3: "(ROTAGAL)",
      subtitle: "A 3-in-1 prevention vaccine designed to reduce calf diarrhea risk and lower farm management burden.",
      mobileQuickLabel: "Mobile Quick Contact",
      mobileQuickTitle: "Submit an inquiry now or connect directly to the lead distributor",
      mobileQuickPrimary: "Submit Inquiry",
      mobileQuickSecondary: "Call Distributor",
    ...
    qualityShowcase: {
      ...
      subtitle: "Rotagal is produced on the same manufacturing basis as Bovigen Scour and backed by both EU GMP certification and Korean national batch-test exemption approval.",
      quick1Label: "Manufacturing Basis",
      quick1Value: "Co-produced at the same Bovigen facility",
      quick2Label: "Supply Stability",
      quick2Value: "Direct 2~8℃ cold-chain import",
      quick3Label: "Korean Proof",
      quick3Value: "National batch test exemption approved",
    ...
    infographic: {
      ...
      scheduleKrLabel1: "First vaccination (primiparous):",
      scheduleKrLine1: "1st dose 6~5 wks →",
      scheduleKrLine2: "2nd dose 3~2 wks before calving",
      scheduleKrLabel2: "Revaccination:",
      scheduleKrLine3: "single dose 6~3 weeks before calving",
      ...
      spec3Desc: "Co-produced with Bovigen, European original vaccine",
    ...
    features: {
      ...
      subtitle: "Only the key advantages that matter most on farm",
      item1Title: "EU GMP Premium Quality",
      item1Desc: "Built on a manufacturing system that meets strict EU GMP standards for stable quality and reliability.",
    ...
    contact: {
      ...
      mobileCardLabel: "Mobile Quick Contact",
      mobileCallBtn: "Call Now",
      mobileInquiryBtn: "Leave Inquiry",
    ...
    inquiry: {
      ...
      advDesc: "If you need academic product information or vaccination guidance, we can connect you right away",
      advTouch: "Touch to connect directly by phone",
      formTitle: "Quick Product Inquiry",
      formSubtitle: "Select your region and the responsible distributor or consultation contact will follow up with you.",
      point1Label: "Response",
      point1Value: "The assigned distributor will contact you after submission",
      point2Label: "Routing",
      point2Value: "Your inquiry is routed by the selected region",
      point3Label: "Privacy",
      point3Value: "Your information is used only for consultation support",
    ...
    footer: {
      ...
      mfg: "Manufacturer: Pharmagal Bio, s.r.o. (Slovakia, EU Plant Approval No. SK 82024 / Co-production site of Bovigen)",
  ...
  sk: {
    ...
    hero: {
      ...
      bannerDesc: "Najvyššia kvalita s certifikátom Európskej únie (EU) GMP · 100% identické európske zloženie s originálom 'Bovigen Scour'",
    ...
    infographic: {
      ...
      scheduleKrLabel1: "Prvá vakcinácia (prvorodičky):",
      scheduleKrLine1: "1. dávka 6~5 týždňov →",
      scheduleKrLine2: "2. dávka 3~2 týždne pred otelením",
      scheduleKrLabel2: "Revakcinácia:",
      scheduleKrLine3: "jedna dávka 6~3 týždne pred otelením",
      ...
      spec3Desc: "Spoločne vyrábané s Bovigen, európska originálna vakcína",
    ...
    footer: {
      ...
      mfg: "Výrobca: Pharmagal Bio, s.r.o. (Slovensko, Schválenie závodu EÚ č. SK 82024 / Spoločný výrobný závod pre Bovigen)",
  ...
  uk: {
    ...
    hero: {
      ...
      bannerDesc: "Найвища якість за стандартами Належної виробничої практики ЄС (EU GMP) · 100% ідентична рецептура з європейським оригіналом «Bovigen Scour»",
    ...
    infographic: {
      ...
      scheduleKrLabel1: "Первинна вакцинація (первістки):",
      scheduleKrLine1: "1-ша доза за 6–5 тижнів →",
      scheduleKrLine2: "2-га доза за 3–2 тижні до отелення",
      scheduleKrLabel2: "Ревакцинація:",
      scheduleKrLine3: "одноразово за 6–3 тижні до отелення",
      ...
      spec3Desc: "Спільне виробництво з Bovigen, оригінальна європейська вакцина",
    ...
    footer: {
      ...
      mfg: "Виробник: Pharmagal Bio, s.r.o. (Словаччина, номер затвердження заводу в ЄС: SK 82024 / Спільне виробництво з Bovigen)",
